...
set(args
  ...
  -DCMAKE_INSTALL_LIBDIR=custom/lib
  "-DTEST_SOURCE_DIR=${source}"
  "-DTEST_PROJECT=${TEST_PROJECT}"
...
# Configure twice and install multiple configurations into the first prefix.
...
#-------------------------------------------------------------------------------
# OWNERSHIP AND REPEAT-UNINSTALL CHECKS
#-------------------------------------------------------------------------------
...
# On POSIX systems, also reject a path that escapes through a directory link.
if(UNIX)
