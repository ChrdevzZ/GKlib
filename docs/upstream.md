# Tracking GKlib upstream changes
...
Run commands from the GKlib repository root with Python 3.9 or newer:
...
```json
{
  "id": "gklib-src-error-c",
  "upstream_path": "src/error.c",
  "local_path": "src/error.c",
  "baseline_blob": "<Git blob id>",
  "kind": "modified",
  "notes": "Identity mapping from the upstream path."
}
```
